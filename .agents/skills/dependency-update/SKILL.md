...
1. Update `<version>` in `pom.xml` (e.g. 6.0.0 → 6.0.1)
...
- If it exists, add a new version entry (e.g. `## [6.0.1] - 2026-04-20`) with a `### Changed` section listing all dependency updates
