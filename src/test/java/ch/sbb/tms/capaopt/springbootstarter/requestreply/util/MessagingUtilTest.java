...
import static ch.sbb.tms.capaopt.springbootstarter.requestreply.util.MessageValidator.correlationId;
import static ch.sbb.tms.capaopt.springbootstarter.requestreply.util.MessageValidator.length;
import static ch.sbb.tms.capaopt.springbootstarter.requestreply.util.MessageValidator.target;
