package community.solace.spring.cloud.requestreply.sampleapps.messageInterceptor;
...
public class RequestReplyTestMessageInterceptorApplication {
    private static final Logger LOG = LoggerFactory.getLogger(RequestReplyTestMessageInterceptorApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(RequestReplyTestMessageInterceptorApplication.class, args);
    }
